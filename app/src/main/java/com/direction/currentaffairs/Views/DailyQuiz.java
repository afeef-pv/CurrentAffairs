...
public class DailyQuiz extends Fragment {
    ...
    private void init(ArrayList<String> dates){
        if(quizView != null){
            ...
            adapterQuiz = new AdapterQuiz(getActivity(),dates, CurrentAffaris.DAILY);
            quizView.setAdapter(adapterQuiz);
        }
    }

    public static DailyQuiz newInstance(String text) {

        DailyQuiz f = new DailyQuiz();
        Bundle b = new Bundle();
